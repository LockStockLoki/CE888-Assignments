...
UCT will function well in this environment because Noughts and Crosses has full observability, presenting the Markov Property.    

A search tree for UCT can be constructed using a state-action model, where the state is the game board and the action is the move made. This will result in a new state. 
